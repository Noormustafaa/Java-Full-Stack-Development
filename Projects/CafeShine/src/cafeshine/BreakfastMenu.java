...
public class BreakfastMenu extends JFrame {
    ...
    String[] itemNames = {
        "Simple Paratha", "Aloo Paratha", "Tea",
    ...
    public BreakfastMenu() {
        setTitle("CafeShine - Breakfast Menu");
        setSize(950, 700);
        setLayout(null);
        setDefaultCloseOperation(EXIT_ON_CLOSE);
        getContentPane().setBackground(new Color(255, 248, 224));

        JLabel title = new JLabel("🍳 CafeShine - Breakfast Menu");
        title.setFont(new Font("Georgia", Font.BOLD, 26));
        title.setBounds(240, 20, 500, 40);
        title.setForeground(new Color(80, 50, 20));
        add(title);

        // Navigation Buttons
        JButton lunchBtn = new JButton("→ Lunch");
        lunchBtn.setBounds(20, 20, 120, 30);
        add(lunchBtn);
        ...
        billButton.addActionListener(e -> {
            ...
            bill.append("====================================\n");
            bill.append("  Have a great morning with us ☀️\n");
        ...
        printButton.addActionListener(e -> {
            try {
                billArea.print(); // Sends to default printer
